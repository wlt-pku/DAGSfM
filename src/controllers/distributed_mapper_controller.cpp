...
DistributedMapperController::DistributedMapperController(
    ...
    const MirrorSimilaritySearchOptions& similarity_search_options,
    ...
    : options_(options),
      ...
      similarity_graph_(similarity_search_options) {
  CHECK(options.Check());
}
...
void DistributedMapperController::Run() {
  ...
  //////////////////////////////////////////////////////////////////
  // //  2. Indexing images by similarity search ///////////////////
  //////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////
  // // 3. Building consistent tracks //////////////////////////////
  //////////////////////////////////////////////////////////////////
  // PrintHeading1("Building Consistent Tracks...");
  // BuildTracks();
  ...
  for (const ImagePair view_pair : view_pairs_to_remove) {
    view_graph_.RemoveTwoViewGeometry(view_pair);
  }
  ...
  //////////////////////////////////////////////////
  //// 9. Optional: Partition Scenes for MVS ///////
  //////////////////////////////////////////////////
...
void DistributedMapperController::LoadTwoviewGeometries() {
  // Loading database.
  Timer timer;
...
void DistributedMapperController::BuildTracks() {
  TrackBuilder track_builder;
  track_builder.Build(track_elements_, track_pairs_);
  track_builder.Filter(options_.min_track_length, options_.max_track_length);
  tracks_ = track_builder.GetConsistentTracks();
}
    ...
    for (uint j = i + 1; j < reg_image_centers.size(); j++) {
      ...
      const ImagePair view_pair =
          reg_image_ids[i] > reg_image_ids[j]
              ? ImagePair(reg_image_ids[j], reg_image_ids[i])
              : ImagePair(reg_image_ids[i], reg_image_ids[j]);
      root_cluster.edges[view_pair] = diff < 1e-6 ? 10000 : 10 / diff;
    }
  }

  clustering_options_.cluster_type = "NCUT";
  clustering_options_.is_output_igraph = false;
...
bool DistributedMapperController::GlobalRotationAveraging() {
  ...
  return rotation_estimator->EstimateRotations(view_pairs, &rotations_);
}
