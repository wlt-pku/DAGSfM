...
template <typename T1, typename T2>
std::unordered_map<size_t, std::unordered_map<size_t, T2>>
Graph<T1, T2>::GetEdges() const {
  return _edges;
}
...
template <typename T1, typename T2>
std::vector<T2> Graph<T1, T2>::ShortestPath(const size_t& src,
...
template <typename T1, typename T2>
std::unordered_map<int, int> Graph<T1, T2>::NormalizedCut(
...
template <typename T1, typename T2>
std::vector<std::unordered_map<size_t, T2>> Graph<T1, T2>::SerializeEdges()
    const {
